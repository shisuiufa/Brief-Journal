...
describe('UpdatePostAction', function () {
    ...
    it('updates a published post without changing its publication timestamp', function () {
    ...
    it('replaces the current image when a new image is provided', function () {
        $post = Post::factory()->create([
    ...
    it('keeps the current image when no new image is provided', function () {
        $post = Post::factory()->create([
            'image' => 'posts/old-image.jpg',
        ]);
    ...
    it('prevents changing the status of a published post', function () {
        $post = Post::factory()->published()->create();
    ...
    it('reports cleanup failure and rethrows the original update exception', function () {
        $post = Post::factory()->create([
            'image' => 'posts/old-image.jpg',
        ]);
    ...
    it('deletes only the newly stored image when update fails and keeps old image untouched', function () {
        $post = Post::factory()->create([
            'title' => 'Old title',
            'slug' => 'old-title',
            'image' => 'posts/old-image.jpg',
