...
it('creates a draft post and keeps published_at null', function () use ($createPostData, $createPost) {
...
it('creates a published post and sets published_at', function () use ($createPostData, $createPost) {
    $user = User::factory()->create();
